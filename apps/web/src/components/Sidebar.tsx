...
export function Sidebar() {
  ...
  const {
    isAdmin, isSyndic,
    availableTenants, switchTenant, switchingTenant, currentTenantName, profile,
  } = useAuthContext();
  ...
  const navigation = [
    ...
    { name: 'Usuarios', href: '/dashboard/users', icon: UserGroupIcon, show: isAdmin },
    ...
    { name: 'Comunicados', href: '/dashboard/announcements', icon: MegaphoneIcon, show: isSyndic },
    ...
    { name: 'Financeiro', href: '/dashboard/financeiro', icon: CurrencyDollarIcon, show: isSyndic },
